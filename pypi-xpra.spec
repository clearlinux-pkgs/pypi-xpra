...
Version  : 5.0.3
Release  : 53
URL      : https://files.pythonhosted.org/packages/48/87/5b4d967d8d3eced221463d576c41560b7898b4e785c061234aaf2006a22f/xpra-5.0.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/48/87/5b4d967d8d3eced221463d576c41560b7898b4e785c061234aaf2006a22f/xpra-5.0.3.tar.gz
...
License  : Apache-2.0 BSD-3-Clause GPL-2.0 GPL-2.0+ GPL-3.0 LGPL-2.0 LGPL-2.1+ LGPL-3.0 LGPL-3.0+ MIT MPL-1.1 Python-2.0
...
%prep
%setup -q -n xpra-5.0.3
cd %{_builddir}/xpra-5.0.3
pushd ..
cp -a xpra-5.0.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1696544940
